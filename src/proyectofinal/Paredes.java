...
//****************CUARTA PIRAMIDE **********************************************************//
    ...
    public void primerCarte() {
        glBegin(GL_QUADS);
        {
            ...
            //Patas del cartel HUMANOS
            glTranslated(50, 0, 50);
            dC.drawRect(1f, 5f, 1f);//atras c1
            glTranslated(-50, -0, -50);
            
            //Cartel HUMANOS
            glTranslated(52, 3, 49.5);
            dC.drawRect(5f, 5f, 0.5f);//atras c1
            glTranslated(-52, -3, -49.5);
        }
        glEnd();
    ...
    public void piernaIzq() {
        glBegin(GL_QUADS);
        {
            ...
            glTranslated(42, 0, 50);
            dC.drawRect(1f, 2f, 1f);//atras c1
            glTranslated(-42, -0, -50);
            
            glTranslated(82, 0, 80);
            dC.drawRect(1f, 2f, 1f);//atras c1
            glTranslated(-82, -0, -80);
    ...
    public void cuerpo() {
        glBegin(GL_QUADS);
        {
            ...
            glTranslated(42, 2, 50);
            dC.drawRect(3f, 3f, 1f);//atras c1
            glTranslated(-42, -2, -50);
            
            glTranslated(82, 2, 80);
            dC.drawRect(3f, 3f, 1f);//atras c1
            glTranslated(-82, -2, -80);
    ...
    public void blazo() {
        glBegin(GL_QUADS);
        {
            ...
            glTranslated(43.1, 3, 50);
            dC.drawRect(1f, 2f, 1f);//atras c1
            glTranslated(-43.1, -3, -50);
            
            glTranslated(83.1, 3, 80);
            dC.drawRect(1f, 2f, 1f);//atras c1
            glTranslated(-83.1, -3, -80);
            ...
            glTranslated(38.9, 3, 50);
            dC.drawRect(1f, 2f, 1f);//atras c1
            glTranslated(-38.9, -3, -50);
            
            glTranslated(78.9, 3, 80);
            dC.drawRect(1f, 2f, 1f);//atras c1
            glTranslated(-78.9, -3, -80);
            ...
            glTranslated(40.75, 5, 50.25);
            dC.drawRect(0.5f, .5f, 0.5f);//atras c1
            glTranslated(-40.75, -5, -50.25);
            
            glTranslated(80.75, 5, 80.25);
            dC.drawRect(0.5f, .5f, 0.5f);//atras c1
            glTranslated(-80.75, -5, -80.25);
    ...
    public void cabeza() {
        glBegin(GL_QUADS);
        {
            ...
            glTranslated(41, 5.25, 50);
            dC.drawRect(1f, 1f, 1f);//atras c1
            glTranslated(-41, -5.25, -50);
            
            glTranslated(81, 5.25, 80);
            dC.drawRect(1f, 1f, 1f);//atras c1
            glTranslated(-81, -5.25, -80);
    ...
    public void cara() {
        glBegin(GL_QUADS);
        {
            ...
            glTranslated(41, 5.25, 49);
            dC.drawRect(1f, 1f, 0.1f);//atras c1
            glTranslated(-41, -5.25, -49);
            
            glTranslated(81, 5.25, 79);
            dC.drawRect(1f, 1f, 0.1f);//atras c1
            glTranslated(-81, -5.25, -79);
